...
/**
 * is_chain_separator - checks if the current character in the buffer is a chain separator
 * @info: the parameter struct
 * @buf: the char buffer
 * @p: address of the current position in buf
 *
 * Return: 1 if it's a chain separator, 0 otherwise
 */
int is_chain_separator(shell_info *info, char *buf, size_t *p)
{
    size_t j = *p;
 ...
 * Return: Void
 */
void check_chain_condition(shell_info *info, char *buf, size_t *p, size_t i, size_t len)
{
    size_t j = *p;
 ...
 */
int replace_aliases(shell_info *info)
{
    int i;
    list_t *node;
    char *p;
 ...
 * Return: 1 if replaced, 0 otherwise
 */
int replace_variables(shell_info *info)
{
    int i = 0;
    list_t *node;
